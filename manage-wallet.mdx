...
- **BTC Balance Display:** Shows your BTC balance held on the platform
- **Runes Value:** Displays the total value of all your Rune tokens in BTC
- **Interactive Animation:** Responsive particle effects that react to mouse movement
...
- **Statistics Badge:** Shows total number of tokens displayed

#### Pagination and Performance
- **Frontend Pagination:** Efficient loading with 10 tokens per page
