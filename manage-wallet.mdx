---
title: Manage Wallet
description: "Complete guide to connecting your wallet, managing balances, and handling deposits and withdrawals on RuneX."
---
...
Your wallet is the central hub for managing your Bitcoin (BTC) and Rune tokens on RuneX. This guide will walk you through connecting your wallet, managing balances, and understanding the different types of balances in the platform.

## Connecting Your Wallet

RuneX supports two major Bitcoin wallets:
...
<Info>
**Security Note:** RuneX uses message signing for authentication. You'll need to sign a unique message each time you connect to verify wallet ownership.
</Info>

## Understanding Your Balances

RuneX displays three types of balances for better asset management:

### 1. Wallet Balance
**Location:** External wallet (Unisat/Xverse)
- Shows tokens currently held in your connected wallet
- Used for deposits into the platform
- Updated automatically when wallet contents change

### 2. Platform Balance  
**Location:** Internal RuneX platform
- Shows tokens deposited into RuneX for trading
- Required for swapping, staking, and DAO participation
- Protected by platform security measures

### 3. Staked Balance
**Location:** Staking contracts
- Shows tokens currently staked for rewards
- Cannot be used for trading while staked
- Earns rewards and provides voting power
