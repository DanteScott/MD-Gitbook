---
title: "Bitcoin & Runes Trading - Meme Dealer"
...
5. Wait for confirmation - You can track through the mini mempool on the swap page or the activity tab on the left.
...
- **Swap Fee**: 1.5% of the transaction amount - 0.5% of fee to LP - 0.25% to REX buybacks - Remaining 0.75% as revenue for Meme Dealer
