...
- **Rare Rune Names**: Launch tokens with coveted names like single letters, numbers, or memorable words
...
**Timeline:**
- Payment confirmation: Usually within 1-6 blocks (10-60 minutes)
- Rune etching: Completed within 24 hours after payment
...
**Choose your path:**
- **Have a rare Rune?** → Connect your wallet and select it from your collection
...
Yes, owning a Rune is mandatory for all token launches on Meme Dealer. You can either bring an existing Rune from your wallet or create a new one through our integrated Rune Etch service powered by OrdinalsBot.
</Accordion>
...
Rune etching costs vary based on Bitcoin network fees and are transparently displayed before payment. You can pay via Bitcoin on-chain or Lightning Network. Costs are determined by OrdinalsBot and current network conditions.
</Accordion>
